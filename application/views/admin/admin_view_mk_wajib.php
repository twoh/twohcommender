...
<div class="container-fluid">
    ...
    <script>
        function insertMK(event){
            ...
            {
                $("#insertMK").load("<?php echo base_url() ?>admin/insert_mk_wajib.twh");
        ...
        function editMK($id_mk,event)
        {
            if($("#insertMK").attr("toggle")=="no")
            {
                $("#insertMK").load("<?php echo base_url() ?>admin/edit_mk_wajib.twh",{
        ...
        function hapusMK($id_mk,event)
        {
            ...
            $("#insertMK").load("<?php echo base_url() ?>admin/delete_mk_wajib.twh",{
                edit_mk: $("#fieldEdit"+$id_mk).val()
            });
            $("#dataMK").load("<?php echo base_url() . 'admin/lihat_mk_wajib' ?> #dataMK");
            event.preventDefault();
