...
<div class="well">            
    <div id="tab-Testing">
        <?php foreach ($mk->result() as $mks): ?>
            ...
            <h4>Beri rating : </h4>        
            <div id="rating">                
                <input class="star" type="radio" name="test-4-rating-3" value="1"/>                
                <input class="star" type="radio" name="test-4-rating-3" value="2"/>                
                <input class="star" type="radio" name="test-4-rating-3" value="3"/>                
                <input class="star" type="radio" name="test-4-rating-3" value="4"/>                
                <input class="star" type="radio" name="test-4-rating-3" value="5"/>
            </div> 
            <br/>
            <br/>
