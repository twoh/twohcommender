    ...
    <div class="row-fluid">
        <div class="span6">
            <h3>
                ...
                Tambah Histori Nilai User <?php $this->session->userdata('user_id') ?>
            </h3>
            <div id="dataMK">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        echo form_open("user/do_tambah_histori_nilai");
                        foreach ($results->result() as $mks):
                            ?>
                            <tr>     
                                <td>
                            ...
                            ?></td>
                                ...
                                $the_key = 0; // or whatever you want
                                foreach (
                                array(
                                    0 => '',
                                    5 => 'A',
